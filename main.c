...
int main(int argc, char *argv[])
{
    ...
    int32_t calib_data[]={28803,26893,50,36424,-10610,3024,8816,-94,-7,9900,-10230,4285,75,388,0,262,50,30};
    //struct bme280_uncomp_data uncomp_data = {326144,557184,28242};
